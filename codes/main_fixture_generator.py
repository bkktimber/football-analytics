...
fixture = '/Users/Mai/Projects/football-analytics/data/epl/20172018/fixtures.csv'
epl_20172018_fixture = pd.read_csv(fixture)

whoscored_data_dir = '/Users/Mai/Projects/football-analytics/data/whoscored/epl/20172018'
...
statsbomb_epl_names = pd.unique(epl_20172018_fixture.home_team.sort_values(ascending=True)).tolist()
...
epl_20172018_fixture_main = pd.merge(epl_20172018_fixture.iloc[:, 1:-1], tmp, on=['home_team', 'away_team'], how='left')
epl_20172018_fixture_main.head(20)

epl_20172018_fixture_main.to_pickle('/Users/Mai/Projects/football-analytics/data/fixtures/20172018/epl_fixture.pkl')